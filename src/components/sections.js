    ...
    return (
        <div class="flex flex-col items-center justify-center" style={{width:"100%"}}>
            ...
            {/* <h4 class="mb-4 text-xl font-extrabold tracking-tight leading-none  md:text-xl lg:text-2xl dark:text-white uppercase">Trouver un rendez-vous</h4> */}
                ...
                <form className="relative flex flex-col space-between shadow-lg"
                    onSubmit={handleSearch}
                    id="searchForm"
                >
                    <div class="flex divide-x-[3px] min-w-full" style={{width:"100%"}}>
                        <div class="relative w-full">
                         
                            <input type="search" id="search" name="search"
                                defaultValue={defaultvalues.healhtpro_name || ""}
                                className="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-l-lg
                        ...
                        <div class="relative w-full  ">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    type="text"
                                    placeholder="Où (ville,region, district, commune...)"
                            ...
                            <button id="search-button" type="submit" class="absolute top-0 right-0 p-2.5
