...
export default function Appointments() {
    ...
    return (
        <section class="bg-white dark:bg-gray-900 h-96 p-2 sm:ml-64">
            <h2 class="text-2xl font-bold text-gray-400 color-meddoc-blue title-meddoc">LISTE DES RENDEZ-VOUS</h2>
            {/* Search----------------------- */}
                                            ...
                                            <td className="px-6 py-4 flex items-center justify-center">

                                                {
                                                    appointment.event_name === "made" && (
                                                        <button onClick={() => { view_consultation(appointment) }} className="meddoc-dark">
