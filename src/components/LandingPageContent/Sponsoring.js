...
export default function Sponsoring() {
  ...
  return (
    <section className="flex flex-col justify-center" id="presse" style={{height:"80vh"}}>
        ...
        <div className="mx-auto" style={{width:520}}>
          {image_slides.map((slide, index) => (
            <SwiperSlide key={index}>
              <div className="flex justify-center items-center mx-auto" style={{ height: '400px !important',}}> {/* Adjust height as needed */}
