...
export default function HeaderConnected() {
    ...
    const userpath = userType == "patient" ? "user" : "healthcare";
    const navigate = useNavigate()
    const link_rendez_vous = `/${userpath}/`+"appointment"
    const link_health_book = "medical_history_book"
    const link_visits_book = "visits_logs_book"


    const link_user_dashboard = `/${userpath}/`+"dashboard"
    const link_user_profile = `/${userpath}/`+"profile"

    const link_user_setting = `/${userpath}/`+"settings"
    const link_healhcare_calendar = `/${userpath}/`+"calendar"
    const link_healhcare_patient_enabled = `/${userpath}/`+"patient_enabled"
    ...
    const UserMenuItems = [
        {
            to: '/user',
            svg: (
                <svg class="w-6 h-6 color-meddoc-orange" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        {
            to: link_rendez_vous,
            svg: (<svg class="w-6 h-6 color-meddoc-orange" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
...

        {
            ...
            svg: (<svg class="w-6 h-6 color-meddoc-orange" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
                <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M4.5 19A3.5 3.5 0 0 1 1 15.5V2a1 1 0 0 1 1-1h5a1 1 0 0 1 1 1v13.5A3.5 3.5 0 0 1 4.5 19Zm0 0H18a1 1 0 0 0 1-1v-5a1 1 0 0 0-1-1h-4.938a1 1 0 0 0-.697.283l-4.238 4.124a1.046 1.046 0 0 0-.164.208C6.986 18.228 6.184 18.705 4.5 19Zm0-4h.01m8.925-12.293 3.536 3.536a1 1 0 0 1 0 1.414L8 16.627v-9.9l4.02-4.02a1 1 0 0 1 1.415 0Z" />
            </svg>),
            text: 'Mes paramètres',
    ...
    const healthcareMenuItems = [
        {
            to: link_user_dashboard,
            svg: (<svg class="w-6 h-6 color-meddoc-orange" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z" />
                <path d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z" />
            </svg>),
...

        {
            ...
            svg: (<svg class="w-6 h-6 color-meddoc-orange" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
...

        {
            ...
            svg: (<svg class="w-6 h-6 color-meddoc-orange" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 19">
        ...
        },
        {
            ...
            svg: (
                <svg class="w-6 h-6 color-meddoc-orange" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                        ...
                        <div class="flex justify-start items-center ">
                            <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar"
                             ...
                             focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                                ...
                                <svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" className="meddoc-blue">
                    ...
                    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                        <ul class="space-y-2 font-medium">
                            ...
                            {menuItems.map((menuItem, index) => (
                                <li key={index}>
                                    <Link to={menuItem.to} className={"flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group " + (location.pathname === menuItem.to ? "meddoc-blue":"")}>
                                        {menuItem.svg}
